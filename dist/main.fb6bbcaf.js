...
menDisplay.addEventListener('mouseleave', function () {
  var hidden = document.getElementById('text__product-Men');
  hidden.style.display = 'block';
});
womenDisplay.addEventListener('mouseenter', function () {
  var hiddenWomen = document.getElementById('text__product-Women');
  hiddenWomen.style.display = 'none';
});
womenDisplay.addEventListener('mouseleave', function () {
  var hiddenWomen = document.getElementById('text__product-Women');
  hiddenWomen.style.display = 'block';
});
childrenDisplay.addEventListener('mouseenter', function () {
  var hiddenChildren = document.getElementById('text__product-Children');
  hiddenChildren.style.display = 'none';
});
childrenDisplay.addEventListener('mouseleave', function () {
  var hiddenChildren = document.getElementById('text__product-Children');
